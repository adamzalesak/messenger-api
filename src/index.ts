...
async function loadLoggedUserId(
  req: express.Request,
...
async function main() {
   ...
   */
  app.post(
    "/conversation/:conversationId([0-9]+)/message",
    loadLoggedUserId,
    async (req: express.Request, res: express.Response) => {
      ...
      const author = await prisma.user.findUnique({
        where: { id: res.locals.loggedUserId },
      });
      if (author == null) {
          ...
          data: {
            ...
            files: {
              ...
              deleteMany: {
                id: {
                  in:
                    req.body.filesDelete != undefined
                      ? req.body.filesDelete
                      : [],
                },
              },
            },
            images: {
              ...
              deleteMany: {
                id: {
                  in:
                    req.body.imagesDelete != undefined
                      ? req.body.imagesDelete
                      : [],
                },
              },
            },
   ...
   */
  app.delete(
    "/conversation/:conversationId([0-9]+)/message/:messageUuid([a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})",
    loadLoggedUserId,
    async (req: express.Request, res: express.Response) => {
      const conversationId = +req.params.conversationId;
